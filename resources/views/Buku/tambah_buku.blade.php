                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('kirim_buku') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="tahun_penerbit">Tahun Penerbit</label>
                                <input type="number" class="form-control @error('tahun_penerbit') is-invalid @enderror" name="tahun_penerbit" id="tahun_penerbit" placeholder="Masukkan Tahun Penerbit" value="{{ old('tahun_penerbit') }}">
